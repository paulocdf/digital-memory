...
| File | Lines | Description |
|------|-------|-------------|
| `themes/hugo-book/layouts/partials/todo-list.html` | ~6,200 | Task management (Inbox): CRUD, subtasks, BuJo, drag-and-drop, finish time |
| `themes/hugo-book/layouts/partials/pomodoro-timer.html` | ~4,020 | Pomodoro timer: floating widget, Focus/Zen mode, ambient visualizer, cross-device sync |
...
| `window.dmPomodoro` | Timer: `start()`, `stop()`, `pause()`, `resume()`, `isActive()`, `getActiveTodoId()` |
